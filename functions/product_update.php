...
if(isset($_POST['submit'])){
    ...
    if (empty($_FILES["book_image"]["name"])){
        ...
        if(count($errors) == 0){
            ...
            if($uploadImage){
                $updateProduct = update_book_fxn($isbn,$book_genre,$book_author,$book_title,$book_price,$book_desc,$target_file,$book_publisher,$book_pub_year,$book_stock);
        ...
        if(count($errors) == 0){
            $updateProduct = update_book_fxn($isbn,$book_genre,$book_author,$book_title,$book_price,$book_desc,$bkimg,$book_publisher,$book_pub_year,$book_stock);
