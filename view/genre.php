...
<body>
  ...
  .nav-link{
    ...
    <br>
    <br>
      <h1 style="font-family:cursive;">Genres</h1>
    <h6 style="font-family:cursive;">Add New Genre</h6>

    <form method="post" action="../functions/genre_add.php">
      <div class="form-row">
        <div class="form-group col-md-6" style="font-family:cursive;">
          <input type="text" class="form-control my-2" id="genrename" name="name" placeholder="Genre">
        </div>
        <div class="form-group col-md-6" style="font-family:cursive;">
    ...
    ?>
        <li class="list-group-item" style="font-family:cursive;"><?php echo $data['genre_name']; ?>
