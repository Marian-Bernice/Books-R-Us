...
<head>
  ...
  <link href="../css/style.min.css" rel="stylesheet">
	...
	<title>Books-R-Us: Update Genre</title>
</head>
<body>
  <style type="text/css">
  .nav-link{
...
.hero-image {
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/genres.png");
    height: 400px;
...
<div class="hero-image">
	...
	<div class="container">
      <h1 style="font-family:cursive;"> Update Genre</h1>


    <form method="post" action="../functions/genre_update.php">
      <div class="form-row">
        <div class="form-group col-md-6" style="font-family:cursive;">
          <input type="text" class="form-control my-2" id="genrename" name="name" value="<?php echo $genre_arr['genre_name']; ?>">
        </div>
        <div class="form-group col-md-6" style="font-family:cursive;">
          <button type="submit" class="btn btn-primary" name="submit">Submit</button>
        </div>
      </div>
      <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>" style="font-family:cursive;">
</form>
